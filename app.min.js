...
this.activeTarget=b,this.clear();var c=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',d=a(c).parents("li").addClass("active");d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.7",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.7",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return e<c&&"top";if("bottom"==this.affixed)return null!=c?!(e+this.unpin<=f.top)&&"bottom":!(e+g<=a-d)&&"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&e<=c?"top":null!=d&&i+j>=a-d&&"bottom"},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);var eeisus=0,eetrue="TRUE",eefalse="FALSE",eedec=".",eeth=",",eedecreg=new RegExp("\\.","g"),eethreg=new RegExp(",","g"),eecurrencyreg=new RegExp("[$]","g"),eepercentreg=new RegExp("%","g");function parseFloatV2(e){return 0==(e=String(e).trim()).indexOf("0x")||0==e.indexOf("0X")||0==e.length?NaN:Number(e)}var co=new Object,fmto=new Object;function readForm(){fmto.XLEW_1_2_5=eegetdropdownvalue(document.getElementsByName("XLEW_1_2_5")),fmto.XLEW_1_2_7=document.getElementById("XLEW_1_2_7").value,fmto.XLEW_1_2_8=document.getElementById("XLEW_1_2_8").value}function unformatInput(){co.XLEW_1_2_5=fmto.XLEW_1_2_5,co.XLEW_1_2_7=eeparseFloat(fmto.XLEW_1_2_7),co.XLEW_1_2_8=eeparseFloat(fmto.XLEW_1_2_8)}function formatOutput(){fmto.XLEW_1_2_9=eedisplayFloat(co.XLEW_1_2_9)}function populateForm(){document.getElementById("XLEW_1_2_9").value=fmto.XLEW_1_2_9}function recalc_onclick(e){ssc.recalcSource=e,readForm(),unformatInput(),calc(co),void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&1==ssc.realtimesync.connection.readyState?ssc.realtimesync.coUpdate(co,e):void 0!==ssc&&void 0!==ssc.realtimesync&&ssc.realtimesync.wsUrl&&ssc.realtimesync.IsCloseByError&&!ssc.realtimesync.IsErrorMsgDialogShown&&!alert("Realtime-Sync is Disconnected, This Form will not save in server and will not collaborate with your partner.")&&(ssc.realtimesync.IsErrorMsgDialogShown=!0),formatOutput(),populateForm()}function str_eq(e,t){return isNaN(e)&&isNaN(t)?e.toLowerCase()==t.toLowerCase():e==t}function eegetdropdownvalue(e){var e=$(e),t=e.get(0).tagName;return null==(t="INPUT"==t?e.hasClass("autocomplete")?e.get(0).value:$("input[name="+e.attr("name")+"]:checked").attr("data-value"):"SELECT"==t?e.get(0).multiple?e.val().join(";"):e.find(":selected").attr("data-value"):e.val())?"":eeunpackdropdownvalue(t)}function myIsNaN(e){return isNaN(e)||"number"==typeof e&&!isFinite(e)}function round(e,t){var n;return isFinite(e)&&isFinite(t)?(n=e<0?-1:1,e=Math.abs(e),t=Math.pow(10,t),n*Math.round(e*t)/t):NaN}function eeparseFloat(e){e=String(e).replace(eethreg,"");e=parseFloatV2(e=String(e).replace(eedecreg,"."));return isNaN(e)?0:e}function eedisplayFloat(e){var t=String(e);return near0RegExp.test(t)&&(e=round(e,8),t=String(e)),t.replace(/\./g,eedec)}var near0RegExp=new RegExp("[.](.*0000000|.*9999999)");function eeunpackdropdownvalue(e){var t,n;return e.length<2?e:(t=e.substring(0,2),n=e.substring(2),"b:"==t?"true"==n.toLowerCase():"n:"==t?parseFloatV2(n):"s:"==t?n:e)}function postcode(){}function TriggerOnchange(e){var t=jQuery.Event("change");$("#"+e).trigger(t)}function submitClick(e){if(focused=!1,ssc.asyncRecalc=!1,recalc_onclick("submit"),ssc.asyncRecalc=!0,0<ssc.pendingUploads)return alert("Please wait until all attachments have finished uploading."),!1;var t=$(".error").filter(":hiddenByParent").length;if(0<t)return showValidateMessage(ssc.exMsg+" : "+t+(1<t?" errors":" error"),"Form validation"),"function"==typeof ssc.focusOnElement&&ssc.focusOnElement($(".error").first()),!1;for(var a=[],n=($("input:file").each(function(e,t){var n=$(this).data("files");a=a.concat(n)}),a.length),i=0;i<n;i++)$("#formc").append("<input type='hidden' id='"+["xll_fileid"+i]+"' name='"+["xll_fileid"+i]+"' value='"+a[i].id+"'/>");$("#formc").submit()}function printAllClick(){null!=ssc.utils?(window.ps=!1,ssc.utils.checkIfFileURI()?$("#printall-fromfile-modal").modal("show"):(recalc_onclick(""),$("#printAllTheme").length||$("head").append("<style id='printAllTheme' type='text/css'>@media print{.panel-default .panel-collapse,.tab-content .tab-pane:not(.hide-printsheet){display:block!important}a{color:inherit;text-decoration:none!important}a:link,a:visited{text-decoration:none}body{background:#fff;color:#000;font:11pt}.tab-pane{page-break-after:always}.tab-pane:last-child{page-break-after:auto}.panel-collapse{page-break-after:always!important}.panel-collapse:last-child{page-break-after:auto}.panel-heading,.jw-header{display:none!important}.jw-step{display:block!important;page-break-after:always}.navbar-default{display:none!important;}}</style>"),window.print(),$("#printAllTheme").remove())):console.log("Printall does not work in file system, please upload your converted page.")}function LoadFromQueryString(){var e=decodeURI(document.location.search);e.indexOf("_readonly"),0<e.length&&$.each(e.substr(1).split("&"),function(e,t){var n,t=t.split("=");2==t.length&&(n=t[0].toString(),t=t[1].toString(),ssc.formBinder.bind(n,t))})}function navigate(e){var t=e.keyCode|e.which;if(13==t||40==t||38==t){var n=$(e.target||e.srcElement);if(!n.is("textarea")&&(!n.is("select")||38!=t&&40!=t)){for(var a=parseInt(n.attr("data-sheet"),10),i=parseInt(n.attr("data-row"),10),r=parseInt(n.attr("data-col"),10),o=!1,s=$("#sheet-"+a),c='input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea',l=i+1,d=i-1,u=l,f=d;40==t&&l<=u||38==t&&f<=d;){var p=s.find(c).filter("[data-sheet="+a+"][data-row="+(38==t?d:l)+"][data-col="+r+"]");if(0<p.length){p.focus(),p.is("input:text, textarea")&&p.select(),o=!0;break}null==s.data("col"+r)?(m=s.find(c).filter("[data-sheet="+a+"][data-col="+r+"]").map(function(){return parseInt($(this).attr("data-row"),10)}).toArray(),s.data("col"+r,m)):m=s.data("col"+r),u=m[m.length-1],f=m[0];var m,p="indexOf"in Array.prototype?m.indexOf(i):$.inArray(i,m);if(40==t&&i<u)l=m[p+1];else{if(!(38==t&&f<i))break;d=m[p-1]}}o||(n=38==t?parseInt(n.attr("tabindex"),10)-1:parseInt(n.attr("tabindex"),10)+1,0<(n=s.find(c).filter("[data-sheet][data-row][data-col][tabindex="+n+"]")).length?0<(n=n.is(":radio")?n.filter(":checked"):n).length&&(n.focus(),n.is("input:text, textarea"))&&n.select():((n=s.find(c).filter("[data-sheet][data-row][data-col][tabindex]:first")).focus(),n.is("input:text, textarea")&&n.select())),e.preventDefault?e.preventDefault():e.returnValue=!1}}}jQuery.expr[":"].hiddenByParent=function(e){var t;return!!e.id.startsWith("xl_")||(t=!1,1==(t=null!=(e=$(e))?"none"!=e.closest("tr[class^='_css']").css("display"):t)?"none"!=e.closest(".tab-pane>div").css("display"):t)};var ssccf1n=function(e,t,n,a){"image"===e&&$("#"+t).attr("src",$("#"+a).attr("src"))},ssccf4n=function(e,t,n,a,i,r,o){e};function calendarCallback(e){var t="popup"==$("#"+e.id).data("caltype")?e.id:"cal_"+e.id,t=$("#"+t),e=e.s1;void 0!==t.data("is-dirty")||""==e||isNaN(e)||(t.datepicker("update",new Date(year(e),eemonth(e)-1,eeday(e))),EE.eeRecalcNeeded=!0)}var ssc=ssc||{},focused=(ssc.pendingUploads=0,ssc.recalcSource="",ssc.APPNAME="KPI SCAFFOLDING",ssc.exMsg="The fields with the red border are required or invalid.",$(window).on("scroll",function(){var e=$(window);$(".position-fixed-x").css("left",e.scrollLeft()),$(".position-fixed-y").css("top",e.scrollTop())}),ssc.Dialog={},ssc.Dialog.BeforeSubmitDesc="The form is being submitted.",ssc.Dialog.OfflineHeading="Save until online",ssc.Dialog.OfflineDesc="You are currently offline and the submit failed. Do you want to save the submit and send it later when you are online.",ssc.Dialog.OfflineConfirm="Do you want to save?",ssc.Dialog.OfflineSubmitHeading="Offline forms submit confirmation",ssc.Dialog.OfflineSubmitDesc="There are Offline form(s), which are now ready to submit in server.",ssc.Dialog.OfflineSubmitConfirm="Do you want to submit?",ssc.Dialog.FailOfflineHeading="Offline Form submit failed",ssc.Dialog.FailOfflineDesc="Unable to connect to the Internet. Please try submitting the offline forms later in internet connection.",ssc.Dialog.OfflineSubmitWait="It may take sometime to finish all submits depending on the size of offline forms and internet connection.",!(ssc.Dialog.OfflineSubmitWaitCounter="Left"));function showValidateMessage(e,t){toastr?t&&0<t.length?toastr.error(e,t):toastr.error(e):alert(e)}function resetClick(){void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&(ssc.realtimesync.connection.close(),ssc.realtimesync.connected=!1,ssc.realtimesync.ShowDisconnectAlert($(".toolbar-panel-right"))),document.formc.reset(),postcode(),LoadFromQueryString(),recalc_onclick("reset")}(n=>{postcode(),ssc.active_sheet_selector="div.active > div.container-fluid.ssc-responsive-sheet > div.row > section",n("a").on("click",function(e){var t=n(this).attr("href");"#"==t.slice(0,1)&&(e.preventDefault(),"#"!=t)&&(0==(e=n(t)).length?alert("Oops! This link is broken so can not navigate."):(focused=!1,ssc.focusOnElement(e)))}),ssc.focusOnElement=function(e){var t;focused||(focused=!0,(t=e.parents(".tab-pane")).hasClass("active")||n('.nav-tabs a[href="#'+t.attr("id")+'"]').tab("show"),n("html, body").stop().animate({scrollTop:e.offset().top-40},900,"swing",function(){e.focus()}))},n(".btn.btn-sm.button-submit.spin-button").on("click",function(){return submitClick(this),!1}),n(".btn.btn-sm.button-reset").on("click",function(){return resetClick(this),!1}),n(".btn.btn-sm.button-update").on("click",function(){return recalc_onclick(""),!1}),n(".btn.btn-sm.button-print.all").on("click",function(){return printAllClick(this),!1});var e=n('input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea,a.ui-state-active');null!=e&&0==e.filter(":first").hasClass("form-control")&&e.filter(":first").focus(),n("textarea[readonly],input[type=text][readonly]").css("background","transparent")})($),ssc.checkIfMSIE=function(){var e=window.navigator.userAgent,t=e.indexOf("MSIE "),e=e.indexOf(".NET CLR");return!(-1===t&&-1===e)};